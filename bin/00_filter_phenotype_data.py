...
print(f"Loaded {len(raw_phenotype_data)} rows")
...
print(f"Removed {n_missing} rows with missing phenotypes")

# Filter outlier phenotypes
print(f"Filtering outliers with IQR multiplier: {args.iqr_multiplier}")
...
print(f"After IQR filtering: {len(filtered_phenotype_data)} rows")

# Filter genotypes with observations in less than min_environments environments
print(f"Filtering genotypes with < {args.min_environments} environments...")
...
print(f"Removed {n_invalid} genotypes with insufficient environments")
print(f"Final filtered data: {len(filtered_phenotype_data)} rows")
...
print(f"\nFiltered data saved to: {args.output_pheno_path}")
